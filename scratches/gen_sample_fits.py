...
header['RA']       = (190.5875, 'Requested field RA')
header['DEC']      = (-0.553333, 'Requested field DEC')
...
header['RA_TEL']   = (190.90214460702, 'Telescope mount RA')
header['DEC_TEL']  = (-0.6876271096903661, 'Telescope mount DEC')
